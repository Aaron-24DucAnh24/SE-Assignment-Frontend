                    ...
                    <div className="authen__wrap">
                        ...
                        <form action="/back-officer" className="authen__form">
                            ...
                            <div className="authen__input-wrap authen__input-wrap--password">
                                <input name="passWord" type="password" maxLength="16" className="authen__input authen__password"
                                    placeholder="Mật khẩu" />
                                <label className="authen__input-icon clickable" htmlFor="password-swicher"><i
                                    className="fa-solid fa-eye-slash password-icon"></i></label>
                                <input type="checkbox" id="password-swicher" style={{ display: "none" }} onClick={passwordSwitch} />
                            </div>
                            <button className="authen__btn clickable" >
                                <a href="/back-officer" >
                                    Đăng nhập
                                </a>
                            </button>
